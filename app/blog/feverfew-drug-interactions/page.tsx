...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://stackverify.app/blog/feverfew-drug-interactions",
  },
};
    ...
    <main className="max-w-2xl mx-auto px-4 py-12 sm:py-16">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Feverfew Drug Interactions: Antiplatelet Effects, Warfarin, and NSAIDs",
      ...
      <div className="mt-10 border-t border-zinc-100 pt-6">
        ...
        <ul className="space-y-1 text-sm">
          ...
          <li><Link href="/blog/saw-palmetto-drug-interactions" className="underline hover:text-zinc-900">Saw Palmetto Drug Interactions: Antiplatelet Effects and Warfarin</Link></li>
        </ul>
      </div>
